...
REGISTER_PLUGIN_BASIC(OpticksEdgeDetection, Sobel);
...
Sobel::Sobel()
{
   setDescriptorId("{2C18B50C-AEBA-48E2-8A2B-0AF95DBCBB52}");
   ...
   setMenuLocation("[Edge Detection]/Sobel Filter");
...
bool Sobel::getInputSpecification(PlugInArgList*& pInArgList)
{
...
bool Sobel::getOutputSpecification(PlugInArgList*& pOutArgList)
{
...
bool Sobel::execute(PlugInArgList* pInArgList, PlugInArgList* pOutArgList)
{
   StepResource pStep("Sobel Edge Detection", "app", "F507FF7E-D991-4FD5-8616-953C3BF8E9D7");
   ...
   pOutArgList->setPlugInArgValue("Sobel_Edge_Result", pResultCube.release());
